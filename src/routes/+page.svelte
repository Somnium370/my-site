...
<section class="hero">
  ...
  <h1 class="text-4xl font-conld mb-4">{greeting}</h1>
  <p class="name">{name}</p>
  <p class="tagline text-gray-600 mb-4">{tagline}</p>
  <!--
    BUTTON with onclick
...
{#if showBio}
  <section class="bio-section">
    ...
    <p>
      ...
      I'm interested in coding and this site showcases my work in web development.
      I'm learning Python, Unity and Svelte right now.
    </p>
  </section>
{/if}
...
<section class="quick-links">
  ...
  <div class="card-row">
    ...
    <a href="/about" class="card">
      <h3>About Me</h3>
      <p>Get to know more about me by clicking here.</p>
    </a>
